...
Also supports direct input from Scanpy AnnData objects via
pc_index_anndata().
...
def pc_index_anndata(adata, layer=None):
    """
    Compute PC-index summary directly from an AnnData object.
    ...
    -------
    pandas.DataFrame
        Same output as summarize_matrix().
    """
    import numpy as np
    import pandas as pd
